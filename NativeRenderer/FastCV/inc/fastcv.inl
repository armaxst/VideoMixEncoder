                        ...
                        void* __restrict          tempBuf)
{
   ...
   fcvAssert ((nmsEnabled==0) || (((int)tempBuf & 0xF) == 0) );     // 128-bit alignment
#endif
                              ...
                              void* __restrict          tempBuf)
{
   ...
   fcvAssert( ((int)xy & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( ((int)scores & 0xF) == 0 );  // 128-bit alignment
   fcvAssert( ((int)bitMask & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( (width & 0x7) == 0 );        // multiple of 8
   fcvAssert( (stride & 0x7) == 0 );        // multiple of 8
   fcvAssert ((nmsEnabled==0) || (((int)tempBuf & 0xF) == 0) );     // 128-bit alignment
#endif
                              ...
                              void* __restrict          tempBuf)
{
   ...
   fcvAssert( ((int)xy & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( ((int)scores & 0xF) == 0 );  // 128-bit alignment
   fcvAssert( ((int)mask & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( (srcWidth & 0x7) == 0 );        // multiple of 8
   fcvAssert( (srcStride & 0x7) == 0 );       // multiple of 8
   fcvAssert ((nmsEnabled==0) || (((int)tempBuf & 0xF) == 0) );     // 128-bit alignment
#endif
...
#ifndef FASTCV_DISABLE_API_ENFORCEMENT
   fcvAssert( ((int)src    & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( ((int)dstY   & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( ((int)dstCb  & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( ((int)dstCr  & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( (srcWidth    & 0x7) == 0 );      // multiple of 8
   fcvAssert( (srcStride   & 0x7) == 0 );      // multiple of 8
                                        ...
                                        uint32_t                  dstCStride )
{
   ...
   fcvAssert( ((int)src   & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( ((int)dstY  & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( ((int)dstC  & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( (srcWidth   & 0x7) == 0 );      // multiple of 8
   fcvAssert( (srcStride  & 0x7) == 0 );      // multiple of 8
   fcvAssert( (dstYStride & 0x7) == 0 );      // multiple of 8
...
#ifndef FASTCV_DISABLE_API_ENFORCEMENT
    fcvAssert( ((int)srcY & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( ((int)integralY & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)integralCb & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)integralCr & 0xF) == 0 );    // 128-bit alignment
...
#ifndef FASTCV_DISABLE_API_ENFORCEMENT
    fcvAssert( ((int)outputMask & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( ((int)bgIntegralY & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)bgIntegralCb & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)bgIntegralCr & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)fgIntegralY & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)fgIntegralCb & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)fgIntegralCr & 0xF) == 0 );    // 128-bit alignment
                            ...
                            void*                   lineBuffer)
{
    ...
    fcvAssert( ((int)src & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( ((int)dst & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)lineBuffer & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( (srcWidth & 0x7) == 0 );          // multiple of 8
    fcvAssert( (srcStride & 0x7) == 0 );         // multiple of 8
...
{
#ifndef FASTCV_DISABLE_API_ENFORCEMENT
   fcvAssert( ((int)A & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)w & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)U & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)Vt & 0xF) == 0 );    // 128-bit alignment
   fcvAssert( ((int)tmpU & 0xF) == 0 );  // 128-bit alignment
   fcvAssert( ((int)tmpV & 0xF) == 0 );  // 128-bit alignment
#endif
                     ...
                     uint32_t dstStride)
{
   ...
   dstStride = (dstStride==0 ? dstWidth * nChannel : dstStride);
      ...
      fcvAssert( ((int)polygon & 0xF) == 0 );    // 128-bit alignment
      fcvAssert( ((int)dst & 0xF) == 0 );        // 128-bit alignment
      fcvAssert( (dstWidth & 0x7) == 0 );        // multiple of 8
      fcvAssert( (dstStride & 0x7) == 0 );       // multiple of 8
                    ...
                    int16_t* resultFlag)
{
      ...
      fcvAssert( ((int)polygonContour & 0xF) == 0 );    // 128-bit alignment
#endif
                                   ...
                                   uint32_t* __restrict tmpBuff)
{
    ...
    fcvAssert( ((int)polygonContour & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)convexHull & 0xF) == 0 );    // 128-bit alignment
    fcvAssert( ((int)tmpBuff & 0xF) == 0 );    // 128-bit alignment
                     ...
                     float32_t *__restrict       x)
{
   ...
   fcvAssert( ((int)A & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)b & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)diag & 0xF) == 0 );  // 128-bit alignment
   fcvAssert( ((int)x & 0xF) == 0 );     // 128-bit alignment
#endif
    ...
    float32_t* __restrict xyCamera)
{
   ...
   fcvAssert( ((int)cameraCalibration & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)xyCamera & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)xyDevice & 0xF) == 0 );     // 128-bit alignment
#endif
                      ...
                      uint32_t* inFront)
{
   ...
   fcvAssert( ((int)pose & 0xF) == 0 );    // 128-bit alignment
   fcvAssert( ((int)cameraCalibration & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)xyz & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)xyCamera & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( ((int)xyDevice & 0xF) == 0 );     // 128-bit alignment
   fcvAssert( (dstStride & 0x7) == 0 );     // multiple of 8
#endif
                     ...
                     uint32_t              mapStride)
{
   ...
   fcvAssert( ((int)src & 0xF) == 0 );          // 128-bit alignment
   fcvAssert( ((int)dst & 0xF) == 0 );          // 128-bit alignment
   fcvAssert( ((int)mapX & 0xF) == 0 );          // 128-bit alignment
   fcvAssert( ((int)mapY & 0xF) == 0 );          // 128-bit alignment
   fcvAssert( (srcWidth & 0x7) == 0 );          // multiple of 8
   fcvAssert( (srcStride & 0x7) == 0 );         // multiple of 8
   fcvAssert( (dstStride & 0x7) == 0 );        // multiple of 8
...
#ifndef FASTCV_DISABLE_API_ENFORCEMENT
   fcvAssert( ((int)warpedImage & 0xF) == 0 ); // 128-bit alignment
   fcvAssert( ((int)targetImage & 0xF) == 0 ); // 128-bit alignment
   fcvAssert( ((int)warpedBorder & 0xF) == 0 ); // 128-bit alignment
   fcvAssert( ((int)targetDX & 0xF) == 0 );    // 128-bit alignment
   fcvAssert( ((int)targetDY & 0xF) == 0 );    // 128-bit alignment
   fcvAssert( ((int)sumJTJ & 0xF) == 0 );      // 128-bit alignment
   fcvAssert( (stride & 0x7) == 0 );           // multiple of 8
                            ...
                            uint32_t *__restrict        dstBorder)
{
    ...
    fcvAssert( ((int)src & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( ((int)dst & 0xF) == 0 );		     // 128-bit alignment
    fcvAssert( ((int)affineMatrix & 0xF) == 0 ); // 128-bit alignment
    fcvAssert( ((int)dstBorder & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( (srcStride & 0x7) == 0 );         // multiple of 8
    fcvAssert( (dstStride & 0x7) == 0 );         // multiple of 8
    fcvAssert( (srcStride >= srcWidth) );        // at least as much as width
    fcvAssert( (dstStride >= dstWidth) );        // at least as much as width
...
#ifndef FASTCV_DISABLE_API_ENFORCEMENT
    fcvAssert( ((int)src & 0xF) == 0 );      // 128-bit alignment
    fcvAssert( ((int)fgMask & 0xF) == 0 );      // 128-bit alignment
    fcvAssert( (srcWidth & 0x7) == 0 );      // multiple of 8
    fcvAssert( (srcStride & 0x7) == 0 );     // multiple of 8
...
#ifndef FASTCV_DISABLE_API_ENFORCEMENT
    fcvAssert( ((int)src & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( ((int)data & 0xF) == 0 );         // 128-bit alignment
    fcvAssert( (srcWidth & 0x7) == 0 );          // multiple of 8
    fcvAssert( (srcStride & 0x7) == 0 );         // multiple of 8
    fcvAssert( (srcStride >= srcWidth) );        // at least as much as width
#endif
                 ...
                 uint8_t               hole_color)
{
    ...
    fcvAssert( ((int)src & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( (srcStride >= srcWidth) );        // at least as much as width
    fcvAssert( ((int) pointBuffer & 0xF) == 0 );          // 128-bit alignment
    fcvAssert( (srcStride & 0x7) == 0 );          // multiple of 8
#endif
