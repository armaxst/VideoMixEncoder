...
import com.maxst.surfaceEncoder.gles.EglCore;
import com.maxst.surfaceEncoder.gles.WindowSurface;
...
public class TextureMovieEncoder implements Runnable {
    ...
    public void startRecording(EncoderConfig config) {
        ...
        mHandler.sendMessage(mHandler.obtainMessage(EncoderHandler.MSG_START_RECORDING, config));
    }
     ...
     * Starts recording.
     */
    public void handleStartRecording(EncoderConfig config) {
